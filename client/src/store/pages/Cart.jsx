...
function CartEmpty({ emptyTitle, emptyMessage, browseProducts }) {
  return (
    <>
      ...
      >
        <PetalDeco
          className="absolute top-8 right-[5%] text-[var(--color-lila)] hidden md:block"
      ...
      <section className="bg-white px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-md mx-auto text-center">
          <div className="relative w-28 h-28 mx-auto mb-8">
            ...
            <PetalDeco
              className="absolute -bottom-3 -right-3 text-[var(--color-lila)]"
...
export default function Cart() {
  ...
  const generateWhatsAppMessage = () => {
    const itemsList = items
      ...
      .join("\n");
    const message = `Hola, quiero encargar este pedido de Pétalos Serena:\n\n${itemsList}\n\n💰 *Total: $${totalPrice.toLocaleString("es-AR")}*`;
  ...
  return (
    <>
      ...
      >
        <PetalDeco
          className="absolute top-6 right-[5%] text-[var(--color-lila)] hidden md:block"
          style={{ width: 140, opacity: 0.1 }}
        />
        <PetalDeco
          className="absolute bottom-2 left-[3%] text-[var(--color-accent)] hidden md:block"
          style={{ width: 80, opacity: 0.25, transform: "rotate(-15deg)" }}
        />
