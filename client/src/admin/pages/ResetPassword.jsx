    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <Link to="/forgot-password" className="text-sm text-cyan-400 hover:text-cyan-300">Volver a recuperar</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center mt-4">
          <Link to="/login" className="text-sm text-zinc-500 hover:text-cyan-400 transition-colors">Volver al login</Link>
        </p>
      </div>
    </div>
  )
